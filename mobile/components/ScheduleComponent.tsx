...
export default function ScheduleComponent(props: any) {
  ...
  const onClickSchedule = () => {
    console.log("Schedule clicked", data.doctor._id);
    router.push({
      pathname: "/doctor-room",
      params: { doctorId: data.doctor._id },
    });
  };

  return (
    <TouchableOpacity style={styles.container} onPress={onClickSchedule}>
      ...
      <View style={styles.bodyContainer}>
        ...
        <View style={styles.bodyItemContainer}>
          ...
          <Text style={styles.bodyItemData}>
            {TruncateText(data.doctor.room, 15)}
          </Text>
        </View>
      </View>
    </TouchableOpacity>
